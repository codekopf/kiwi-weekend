...
def main(argv):
    ...
    # TODO Mockup object
    json_data = {}
    json_data['booking_token'] = extracted_booking_token
    json_data['bags'] = "0"
    json_data['currency'] = "EUR"
    json_data['passengers'] = [{'lastName': "tomson", 'title': "Mr", "firstName": "isabel", "email": "asd@asd.com", "documentID": "4888789", "birthday": "1920-12-30"}]

    json_data = json.dumps(json_data)

    #payload = { booking_token': extracted_booking_token, 'currency': "EUR", 'passengers': [{ 'lastName': "tomson", 'title': "Mr", "firstName": "isabel", "email": "asd@asd.com", "documentID": "4888789", "birthday": "1920-12-30"}]}
    # """ % (booking_token)
